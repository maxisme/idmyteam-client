    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.PositiveSmallIntegerField(choices=[(0, 'Phantom Member'), (1, 'Classify Member'), (2, 'Medium Member'), (3, 'High Member')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Trained'), (2, 'Recognised')])),
