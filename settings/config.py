...
ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(sys.modules['__main__'].__file__), os.pardir))
...
CAMERA_RESTART_SETTINGS = ['Resolution', 'Flip Vertically', 'Framerate', 'Shutter Speed']
...
PERMISSIONS = {
    NO_PERM: {
        "level": 0,
        "description": "Only to be recognised."
    },
    "low": {
        "level": 1,
